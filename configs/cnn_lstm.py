...
# Test configuration
path_punctuation = "../saves_2/cnn_lstm_false/cnn_lstm_10_01_2022_14_22_24/best_model.pth"     # path to model with punctuation
path_no_punctuation = "../saves_2/cnn_lstm_true/cnn_lstm_10_01_2022_14_32_23/best_model.pth"    # path to model with no punctuation
