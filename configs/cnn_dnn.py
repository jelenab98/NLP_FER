...
# Test configuration
path_punctuation = "../saves_2/cnn_dnn_false/cnn_dnn_10_01_2022_14_04_58/best_model.pth"     # path to model with punctuation
path_no_punctuation = "../saves_2/cnn_dnn_true/cnn_dnn_10_01_2022_14_13_13/best_model.pth"    # path to model with no punctuation
