...
# Test configuration
path_punctuation = "../saves_2/lstm_rnn_false/lstm_rnn_10_01_2022_14_45_02/best_model.pth"     # path to model with punctuation
path_no_punctuation = "../saves_2/lstm_rnn_true/lstm_rnn_10_01_2022_14_56_53/best_model.pth"    # path to model with no punctuation
