...
if __name__ == '__main__':
    ...
    conf_path = Path("../saves/new/lstm_rnn_21_06_2021_14_28_29/config.py")
    ...
    check_svm(y_test_punct, y_test_punct, y_test_punct)
    exit()
